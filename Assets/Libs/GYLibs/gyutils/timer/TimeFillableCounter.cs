...
{
    public class TimeFillabeleCounter : IFrame
    {
        /// <summary>
        /// Time.realTimeSinceStartUp or Time.time
        /// </summary>
        ...
        public TimeFillabeleCounter(float interval = 1f, bool autoDispose = false, TimeCounterDelegate func = null, string registerName = "", EnterFrame targetFrame = null)
        {
        ...
        public void Update()
        {
            ...
            {
                float deltaTime = (useRealTime ? Time.realtimeSinceStartup : TimeUtil.shareTimeSincePlay - _lastTime) * 1000;
                if (deltaTime >= _interval)
                {
                    oneFrameWork();
                    _lastTime = useRealTime ? Time.realtimeSinceStartup : TimeUtil.shareTimeSincePlay;
                }
            }
        }
